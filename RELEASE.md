...
>
> ⚠️ **Bundle-Lag-Lehre (10.09.2026):** Die Action-Version (v4.37.9, SHA-gepinnt) und der Default-**Bundle**-Stand sind **zwei getrennte Versionen** — Dependabot aktualisiert den Pin erst Tage/Nach der Bundle-Bump-Release. Nach dem Kotlin-2.4.20-Bump lehnte Bundle **2.26.4** die GA-Version noch ab („Kotlin version 2.4.20 is too recent“, Tracking github/codeql#22404) → CI rot, obwohl der Issue am Vortag geschlossen war. Der Wächter (b2d92ed entfernt) war deshalb zu früh weg. Fix: Pin auf **v4.38.0** gehoben (Default-Bundle **2.27.0**, released 09.09.2026 — erster Train, der den Kotlin-2.4.20-Extractor aus PR github/codeql#20018 ausliefert). **Für künftige Kotlin-Bumps gilt:** vor dem Bump die Bundle-Release-Notes auf Extractor-Support prüfen, sonst die GA-Version blockiert die CodeQL-Analyse.
