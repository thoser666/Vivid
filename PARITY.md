...
> **Stand:** 2026-08-20 · Aktualisierung: **Beta-Gate 3/3 erreicht** — (1) **17/17 ✅** (Row 80 „Chat-Bot: Media-Player-Steuerung“ ist der 17. Moblin-✅), (2) **Chat-✅** mit Twitch-Scope (Row 77: Twitch-IRC + Overlay + KI-Bot; Kick/YouTube/SOOP/OAuth = Post-Beta-Roadmap), (3) **≥1 Widget ✅** (Row 87: Text-/Info-Widget Zeit/GPS/Geschwindigkeit). Erste Beta-Releases veröffentlicht: `v0.5.0-beta` … `v0.5.3-beta` (zuletzt 19.08.) — Referenzstand: Moblin **33.12.0**
>
