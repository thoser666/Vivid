...
| `v0.5.0-beta` | **Kamera & Video (11):** Color-Spaces/3D-LUTs, Video-Effekte, Externes Zubehör, Photo-Shoot, Szenen + Auto-Scene-Switcher, Pro-Kamera-Steuerung + Linsen-Auswahl, Screen-Capture/Video-Player-Quelle (**S1 Source-Abstraktion ✅ fertig**: `VideoSourceKind`/`VideoSource`/`VideoSourceRegistry` + Engine-Anbindung — S2 Screen-Capture/S3 Video-Player folgen), Replays (Record-to-Disk), Low-Light-Boost, Externes Display/Cast, VTuber/PNGTuber · **Audio (3):** Mic-Verwaltung, Level-Meter/Muting/Sync, Talk-Back · Oura-Ring- + BLE-Sensoren | **49** | Beta #3 |
