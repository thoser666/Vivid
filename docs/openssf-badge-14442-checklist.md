...
| `test_statement_coverage80` | S | **Uj** | Measured via Kover (merged, 9 modules): LINE 69.3 % overall after the settings/widgets Robolectric round (06.09.2026; feature-settings/ui 90.2 %, feature-widgets 57.2 %, feature-streaming 66.6 %, help 100 %); 80 % statement coverage is the documented next goal (docs/cii-best-practices-badge.md). |
...
| `test_statement_coverage90` | S | **Uj** | See `test_statement_coverage80` — measured LINE 69.3 %; documented goal. |
