...
- **Fuzzing (#43), CIIBestPractices (#45):** Prozess-/Einrichtungsthemen, keine Quellcode-Änderungen. Für das OpenSSF CII Best Practices Badge (Grundlage von #45) gibt es eine vollständige Kriterien-Checkliste in [`docs/cii-best-practices-badge.md`](docs/cii-best-practices-badge.md).
