...
| 36 | `test_most` | Met justification *(SUGGESTED)* | Gemessen via Kover-Report (CI-Artefakt `coverage-report`): LINE 69,3 % gesamt (Settings/Widgets-Runde 06.09.2026, vorher 47,2 % / 35,3 %), BRANCH/METHOD siehe Report; feature-streaming 66,6 %, feature-settings/ui 90,2 %, feature-widgets 57,2 %, app help 100 %; StreamingEngine 99,5 % LINE, LUT-/Robolectric-Pfade 100 %; Restlücke Richtung 80 % liegt vor allem in app/ui-Compose-Screens |
